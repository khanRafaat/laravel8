                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="text-danger">No Time Found</span>
                                        @else
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{url('delete/category/permanently/'.$category->id)}}"
                                        class="btn btn-outline-danger" onclick= "return confirm('Are you sure want to delete ?')">Delete</a>
